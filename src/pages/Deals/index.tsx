...
export default function Deals() {
  ...
  const { data: apiDealProducts, isLoading } = useBestSellerProducts(50); // Get more for filtering

  // Filter products with applied filters
  const dealProducts = useMemo(() => {
    if (!apiDealProducts?.success || !apiDealProducts.data) {
      return [];
    }

    let filteredProducts = apiDealProducts.data;
