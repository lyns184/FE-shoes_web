...
export default function New() {
  ...
  const { data: apiNewProducts, isLoading } = useNewProducts(50); // Get more for filtering

  // Filter products with applied filters
  const newProducts = useMemo(() => {
    if (!apiNewProducts?.success || !apiNewProducts.data) {
      return [];
    }

    let filteredProducts = apiNewProducts.data;
            ...
            {isLoading ? (
              ...
              <>
                ...
                <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-200">
                  <p className="text-gray-600">
                    <span className="font-semibold">{newProducts.length}</span> products
                  </p>
