...
const TotalCard = ({ title, amount, unit }: TotalCardProps) => {
  return (
    <div className="bg-white rounded-2xl border-2 border-neutral-200 p-5 shadow-sm">
      <div className="flex items-start justify-between">
        <div className="flex-1 min-w-0">
          <h3 className="text-neutral-900 text-base font-normal mb-1">{title}</h3>
          <p className="text-neutral-900 text-xl lg:text-2xl font-bold truncate">
            {amount.toLocaleString()}{unit}
          </p>
        </div>
        <div className="bg-emerald-200 rounded-xl p-3 flex items-center justify-center shrink-0 ml-3">
