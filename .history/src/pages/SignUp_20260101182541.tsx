...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-white flex flex-col">
      <div className="absolute inset-0 bg-gradient-to-br from-[#396254]/10 via-[#396254]/5 to-[#396254]/10" />
      
      {/* Header */}
      <header className="relative z-10 border-b bg-white/80 backdrop-blur-sm py-4">
