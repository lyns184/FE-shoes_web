  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 py-8">
        {/* Back Button */}
        <button className="mb-6 flex items-center justify-center w-10 h-10 rounded-full border border-gray-300 hover:bg-gray-50 transition-colors cursor-pointer">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex flex-col gap-2">
              {[1, 2, 3, 4].map((_, index) => (
                ...
                >
                  <img src="/shoe.png" alt="Thumbnail" className="w-full h-full object-contain p-1" />
                </div>
              ))}
            </div>
            {/* Main Image */}
          ...
          {/* Product Info */}
          <div>
            <h1 className="text-3xl font-bold mb-2">Jordan 1 Retro Low OG SP</h1>
            <p className="text-xl text-gray-600 mb-6">Travis Scott Velvet Brown</p>
            ...
            <div className="border border-gray-300 rounded-lg p-6 mb-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  ...
                  <span>61 Sold in last 3 days</span>
                </div>
              </div>
