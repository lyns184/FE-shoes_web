    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
      ...
      <div className="bg-white rounded-lg shadow-sm w-full max-w-md">
        ...
        <div className="p-8">
          ...
          {/* Social Login */}
          <div>
            <p className="text-center text-sm text-gray-700 mb-3">Sign up with</p>
            <div className="flex justify-center gap-3">
              <button
                type="button"
                className="w-12 h-12 flex items-center justify-center border border-gray-300 rounded-md hover:bg-gray-50 transition-colors"
