        ...
        <aside className="w-56 bg-white border border-gray-200 h-fit rounded-lg">
          ...
          <nav className="p-4">
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 text-left rounded-lg transition-colors mt-2 ${
                activeMenu === 'history'
                  ? 'bg-[#396254] text-white'
                  : 'text-gray-700 hover:bg-gray-50'
              }`}
          ...
          {activeMenu === 'profile' && (
            <>
              <div className="flex items-center justify-between mb-6">
                ...
                <button className="px-6 py-2 border border-gray-300 rounded-full text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors flex items-center gap-2">
              ...
              <div className="border-t border-gray-200 pt-8">
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div className="border border-gray-200 rounded-lg p-4 relative hover:shadow-md transition-shadow">
                    <button className="absolute top-4 right-4 text-sm text-gray-600 hover:text-gray-900 flex items-center gap-1">
                      <FiEdit2 className="w-4 h-4" />
                    </button>
