        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-3 pt-4">
                <button
                  ...
                  className="bg-[#396254] hover:bg-[#2d4d3f] text-white px-8 py-2 rounded-full font-medium transition-colors"
                >
                  Go Home
                </button>
                <button
                  onClick={() => window.location.href = '/help'}
                  className="border-2 border-gray-900 text-gray-900 hover:bg-gray-100 px-8 py-2 rounded-full font-medium bg-transparent transition-colors"
                >
                  Help
                </button>
              </div>
            ...
            <div className="relative flex items-center justify-center">
              <img src={notFoundImg} alt="404 Not Found" className="w-full h-auto max-w-md" />
            </div>
          </div>
        </div>
      </main>
