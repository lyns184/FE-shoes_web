    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <div className="flex justify-end mt-2">
          <button type="button" className="text-xs text-gray-900 underline hover:no-underline font-semibold">
            Forgot password?
          </button>
        </div>
      </div>
      ...
      <p className="text-xs text-gray-600 pt-2 text-center">
        By logging in you agree to the <span className="font-semibold">Terms</span> and <span className="font-semibold">Privacy</span>
      </p>
